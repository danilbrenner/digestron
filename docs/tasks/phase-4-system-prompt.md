...
- [ ] **p4-system-prompt-file** — Move system prompt to an embedded resource file  
...
- [ ] **p4-token-usage** — Surface token usage in the digest message  
...
- [ ] **p4-reload-prompt** — Add /reload-prompt command  
