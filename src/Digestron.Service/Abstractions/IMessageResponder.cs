...
public interface IMessageResponder
{
    ...
    Task SendDigestAsync(MessageContext context, string markdownText, int totalTokens, CancellationToken ct);
    Task SendPromptReloadedMessageAsync(MessageContext context, CancellationToken ct);
}
